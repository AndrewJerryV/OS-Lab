...
int main() {
    ...
    if (sharedBuffer->process1 != 1 && sharedBuffer->dataStatus1 == 0 && sharedBuffer->dataStatus2 == 0 && sharedBuffer->exitRequest == 0) {
        isProcess1 = 1;
        sharedBuffer->process1 = 1;
        printf("Running as Process 1 (Type messages, 'STOP' to exit)\n");
    } else {
        isProcess1 = 0;
        sharedBuffer->process1 = 0;
